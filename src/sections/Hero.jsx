...
const Hero = () => {
  return (
    <section className="max-container w-full flex xl-flex-row flex-row bg-black min-h-[449px] gap-10 border-2 rounded-3xl ">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x p-[60px] ml-12">
      ...
      <div className="relative flex-1 flex justify-center items-center ">
        ...
        width={680 }
        height={502}
        className='object-contain relative z-10 rounded-r-2xl' 
        />
      </div>
    </section>
  )
